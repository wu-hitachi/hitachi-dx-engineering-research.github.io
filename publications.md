...
- 林 晋平, 小林 隆志 (東京工業大学), 高井 康勢, 加藤 正恭（2022年9月）.
  [言語横断バグ箇所検索手法の日本語記述への適用可能性](http://id.nii.ac.jp/1001/00219953/), 
  ソフトウェアエンジニアリングシンポジウム2022, pp.131-136. **🎖SES研究奨励賞**

- 前島 葵, 肥後 芳樹, 柗本 真佑, 楠本 真二 (大阪大学), 安田 和矢 (2022年9月). 
  [大規模データセットと多種ミュータント演算子を利用した自動修正適合性の再計測](http://id.nii.ac.jp/1001/00219945/), 
  ソフトウェアエンジニアリングシンポジウム2022, pp.61-70. **🎖SES研究奨励賞**

- Sien Reeve Peralta, Hironori Washizaki, Yoshiaki Fukazawa (Waseda University), Yuki Noyori, Hideyuki Kanuka and Shuhei Nojiri, Analysis of Bug Report Qualities with fixing time using Causal and Inference Model,
  ソフトウェアエンジニアリングシンポジウム2022,  **🎖SES企業・ポスター賞**

- 関根 理敏, 新原 敦介, 明神 智之, 今谷 恵理 (2022年9月).
  [データセットの多種多様な属性情報抽出に向けた多面的クラスタリング変分オートエンコーダの手書き文字データへの適用](http://id.nii.ac.jp/1001/00219956/),
  ソフトウェアエンジニアリングシンポジウム2022,pp.145-146.

- 曾我 遼，鹿糠 秀行，福井 大輔，間瀬 正啓 (2022年8月). 
  AIを含む業務プロセスのリスク評価手法. 
  日本ソフトウェア科学会大会.
...
- Takahiro Kinoshita, Hideyuki Kanuka (March, 2022).
   [Automated Microservice Decomposition Method as Multi-Objective Optimization](https://doi.org/10.1109/ICSA-C54293.2022.00028).
   IEEE 19th International Conference on Software Architecture Companion (ICSA-C), pp.112-115.
